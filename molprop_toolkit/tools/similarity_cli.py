#!/usr/bin/env python
"""
molscope similarity: Find similar compounds in a molecular library.
...
molscope similarity "CCO" library.smi -o results.csv

# Search with specific fingerprint and threshold
molscope similarity "c1ccccc1" library.csv --fp morgan --threshold 0.7 --top 20

# Search from a query file (multiple queries)
molscope similarity queries.smi library.csv --batch -o similarity_results/
...
<body>
    <div class=\"container\">
        ...
        <p class=\"subtitle\">MolScope Toolkit</p>
...
"""
    ...
    html += """            </tbody>
        ...
        <p class=\"footer\">Generated by MolScope Toolkit</p>
    </div>
</body>
</html>
"""
